defmodule SonosMcp.MCP.Tools.Diagnostics do
  @behaviour EMCP.Tool
  ...
  defp build_report(speaker, transport, position, media, zone_info) do
    sections = [
      ...
      "Role: #{if SonosMcp.Speaker.coordinator?(speaker), do: "Coordinator", else: "Member (coordinator: #{speaker.coordinator_uuid})"}",
      "",
      "-- Transport --",
